...
jQuery(window).load(function() {
	...
	jQuery(".preloader").delay(0).fadeOut("2000");
})
...
$('.mailchimp').ajaxChimp({
    ...
    url: "http://mothercitydesigns.us10.list-manage.com/subscribe/post?u=96081f746cbbea4a1f53fdcda&amp;id=09490f03f5" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
});
